...
class CustomizedInputs extends React.Component {
    ...
    handleInputChange = name => event => {
        this.setState({
            ...
            {
                this.state.username.length < 3 ? this.setState({ usernameError: true }) :
            ...
            {
                regPassword.test(this.state.password) !== true && this.state.password !== '' ? this.setState({ passwordError: true }) :
            ...
            {
                this.state.species.length < 3 && this.state.species !== '' ? this.setState({ speciesError: true }) :
